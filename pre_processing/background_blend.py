...
def blend_with_random_background(
    main_image, background_dir, blur_radius=1, brightness_factor=1.2
):
    background_images = [
        f
    ...
    background_image_path = os.path.join(
        background_dir, random.choice(background_images)
    )
