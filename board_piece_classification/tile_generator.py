...
def to_tf_datasets(ds_dict, output_path):
    ...
    hex_encoder_path = f'{output_path}/label_encoder/label_encoder_hexagons_expanded.pkl'
...
def generate_tile_image(image_path, bg_path, final_img_shape, number=None, font_path=None, tile_type='desert'):
...
if __name__ == '__main__':
    ...
    backgrounds_path1 = '../data/tile_datasets/tile_backgrounds/type_1'
    backgrounds_path2 = '../data/tile_datasets/tile_backgrounds/type_2'
        ...
        for tile_index in range(1, 4):
            ...
            for background in backgrounds:
                ...
                for number in valid_numbers:
                    # Generate image
                    img = generate_tile_image(img_path, bg_path, img_size, number, font_path, tile)

                    # Save image
                    img.save(f'{output_img_path}/{tile}_{tile_index}_no_{number}_bg_{bg_index}.png')
