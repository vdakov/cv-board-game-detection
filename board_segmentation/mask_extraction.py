...
def get_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="sam_checkpoint/sam_vit_h_4b8939.pth",
    )
    parser.add_argument(
        "--model_name",
    ...
    parser.add_argument(
        ...
        type=str,
        default="../catan_data/mined_synthetic_boards_sample/",
    )
    parser.add_argument(
        "--save_dir",
        help="Echo the path to the directory where you want your hexagons saved",
        type=str,
        default="../catan_data/mined_synthetic_tiles_sample/",
    )
...
if __name__ == "__main__":
    ...
    for i in range(1):
        ...
        for idx, hexagon in enumerate(hexagons):
            ...
            cv2.imwrite(
                save_path, cv2.cvtColor(hex_crop, cv2.COLOR_RGB2BGR)
            )  # Save the hexagon
