...
def show_train_test_loss(training_losses, test_loss, num_epochs, title="Training and Test Loss Over Epochs"):
    """
    ...
    plt.plot(epochs, training_losses, marker='o', linestyle='-', color='#3498db', label='Training Loss', linewidth=2, markersize=6)
